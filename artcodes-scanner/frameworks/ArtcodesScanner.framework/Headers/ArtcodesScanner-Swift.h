...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ArtcodesScanner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

enum Match : NSInteger;
@class NSNumber;
enum ChecksumOption : NSInteger;
...
- (enum ChecksumOption)getChecksumOption SWIFT_WARN_UNUSED_RESULT;
...
typedef SWIFT_ENUM(NSInteger, ChecksumOption, closed) {
  ChecksumOptionOptional = 0,
  ChecksumOptionRequired = 1,
  ChecksumOptionExcluded = 2,
};
...
@property (nonatomic, copy) NSString * _Nullable highlightBackgroundColor;
@property (nonatomic, copy) NSString * _Nullable highlightForegroundColor;
@property (nonatomic, copy) NSString * _Nullable scanScreenTextTitle;
@property (nonatomic, copy) NSString * _Nullable scanScreenTextDesciption;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (Action * _Nullable)actionForCode:(NSString * _Nonnull)code SWIFT_WARN_UNUSED_RESULT;
- (BOOL)isFullscreen SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_PROTOCOL("_TtP15ArtcodesScanner13FocusCallback_")
...
typedef SWIFT_ENUM(NSInteger, Match, closed) {
  MatchAny = 0,
  MatchAll = 1,
  MatchSequence = 2,
};
...
@interface ScannerViewController : UIViewController <FocusCallback>
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified actionButton;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified actionButtonContainer;
